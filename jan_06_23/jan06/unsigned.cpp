...
Unsigned Unsigned::operator-(const Unsigned &autre) const {
    ...
    string result = "";
    int emprunt = 0;
    int size1 = format_binaire.size();
    int size2 = autre.format_binaire.size();
...
Unsigned Unsigned::operator%(const Unsigned &autre) const {
    ...
    Unsigned quotient = *this / autre;  
    Unsigned produit = quotient * autre;  
    Unsigned reste = *this - produit;  
