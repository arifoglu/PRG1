...
//}
Int Int::operator*(const Int& autre) const {
    Unsigned produit = this->valeur_absolue * autre.valeur_absolue;  
    return Int(produit, this->est_negatif != autre.est_negatif);  
}
...
//}
Int Int::operator%(const Int& autre) const {
    Unsigned reste = this->valeur_absolue % autre.valeur_absolue;  
    return Int(reste, false);  
}
...
Int::Int(const Unsigned& nombre) {
    this->valeur_absolue = nombre;
    this->est_negatif = false; 
}
Int::Int(const Unsigned& nombre, bool negatif) {
    this->valeur_absolue = nombre;
    this->est_negatif = negatif;
}
