...
// Initialisation de la base par défaut (10)
int Unsigned::Setbase::base_affichage = 10;

// changer la base
void Unsigned::Setbase::set_base(int base) {
    if (base < 2 || base > 36) {
        base = 10; // par défaut
    }
    base_affichage = base;
...
ostream &operator<<(ostream &os, const Unsigned &u) {
    int base = Unsigned::Setbase::base_affichage;
